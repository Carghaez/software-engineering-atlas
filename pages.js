...
export const PAGES = [
{
  ...
  groups:[
    ...
    { label:'Declarative root — describe WHAT', note:'Specify the result; the engine decides execution.', ids:['declarative','functional-programming','logic-programming'] },
    { label:'Dataflow & reactive', note:'Computation driven by data availability / change.', ids:['dataflow-programming','reactive-programming','event-driven'] },
    ...
    { label:'Data- & performance-oriented', note:'Organise around data layout and the machine.', ids:['data-oriented-design','ecs'] },
    { label:'Concurrent & distributed', note:'Structure around independent, communicating units.', ids:['actors','csp-channels','async-await'] },
...
},
{
  ...
  groups:[
    ...
    { label:'2 · Composition & evaluation', note:'How small functions combine.', ids:['function-composition','currying','lazy-evaluation','tail-call-optimization','continuation-passing-style'] },
    { label:'3 · Data modelling', note:'Make illegal states unrepresentable.', ids:['algebraic-data-types','pattern-matching','persistent-data-structures'] },
    { label:'4 · Algebraic structures', note:'Laws enabling generic, parallel-safe combination.', ids:['monoid','functor','applicative','monad'] },
    { label:'5 · Effect types', note:'Encode failure / optionality / context in the type.', ids:['option-maybe','result-either'] },
    { label:'6 · Advanced effects & optics', note:'Composing and focusing effects (mostly HKT-rich langs).', ids:['monad-transformers','algebraic-effects','lenses-optics'] },
  ]
},
{
  ...
  groups:[
    { label:'Discipline', note:'When and how strongly types are checked.', ids:['static-dynamic-typing','gradual-typing','type-inference'] },
    { label:'Polymorphism', note:'One piece of code over many types.', ids:['parametric-polymorphism','subtype-polymorphism','typeclasses-traits','variance','generic-programming'] },
    { label:'Data modelling', note:'Compose and constrain data shapes.', ids:['algebraic-data-types','gadts','newtype'] },
    { label:'Substructural & state', note:'Track usage, ownership and protocol in the type.', ids:['linear-affine-types','ownership-borrowing','typestate','phantom-types'] },
...
},
{
  ...
  groups:[
    { label:'Within one core', note:'No threads involved.', ids:['instruction-level-parallelism','simd','auto-vectorization','fma','branchless-programming'] },
    { label:'Across cores', note:'Task & data parallelism on a CPU.', ids:['threads','thread-pool','work-stealing','spmd'] },
...
},
{
  ...
  groups:[
    ...
    { label:'Pragmatic principles', note:'Broad, contextual maxims.', ids:['separation-of-concerns','dry','composition-over-inheritance'] },
    { label:'Patterns & wiring', note:'Reusable object-level solutions.', ids:['dependency-injection','strategy-pattern','mvc'] },
    { label:'Application architectures', note:'How a codebase is structured.', ids:['layered-architecture','hexagonal-architecture','clean-architecture'] },
    { label:'Distributed architectures', note:'Topologies across services.', ids:['microservices','event-driven-architecture','serverless','ecs'] },
...
},
{
  ...
  groups:[
    { label:'Secure design', note:'Build security in from the start.', ids:['threat-modeling','secure-by-design','defense-in-depth','least-privilege','zero-trust'] },
    { label:'Identity & access', note:'Who you are; what you may do.', ids:['authentication','authorization','sandboxing'] },
    { label:'Data & crypto hygiene', note:'Protect secrets and side channels.', ids:['secret-management','constant-time-programming','output-encoding'] },
    { label:'Supply chain & integrity', note:'Trust the artifacts and the build.', ids:['supply-chain-security','code-signing','audit-logging'] },
  ]
},
{
